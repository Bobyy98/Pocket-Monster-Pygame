...
class Game:
	...
	def import_assets(self):
		self.tmx_maps = tmx_importer('10 full project/data/maps')

		self.overworld_frames = {
			'water': import_folder('10 full project/graphics/tilesets/water'),
			'coast': coast_importer(24, 12, '10 full project/graphics/tilesets/coast'),
			'characters': all_character_import('10 full project/graphics/characters')
		}

		self.monster_frames = {
			'icons': import_folder_dict('10 full project/graphics/icons'),
			'monsters': monster_importer(4,2,'10 full project/graphics/monsters'),
			'ui': import_folder_dict('10 full project/graphics/ui'),
			'attacks': attack_importer('10 full project/graphics/attacks')
		}
		self.monster_frames['outlines'] = outline_creator(self.monster_frames['monsters'], 4)

		self.fonts = {
			'dialog': pygame.font.Font(join('10 full project/graphics/fonts/PixeloidSans.ttf'), 30),
			'regular': pygame.font.Font(join('10 full project/graphics/fonts/PixeloidSans.ttf'), 18),
			'small': pygame.font.Font(join('10 full project/graphics/fonts/PixeloidSans.ttf'), 14),
			'bold': pygame.font.Font(join('10 full project/graphics/fonts/dogicapixelbold.otf'), 20),
		}
		self.bg_frames = import_folder_dict('10 full project/graphics/backgrounds')
		self.start_animation_frames = import_folder('10 full project/graphics/other/star animation')
	
		self.audio = audio_importer('10 full project/audio')
